...
{
    [TestClass]
    public class TestFindLowestTempDaysOfYear
    {

        //  Input ({WeatherData.Days} in WeatherData)                                            Expected output
        //  [{1/1/2015,50,15}]                                                                 [{1/1/2015, 50, 15}]
        //  [{1/1/2015,50,15}, {1/2/2015,45,25}, {1/3/2015,40,30}]                             [{1/1/2015, 50, 15}]
        //  [{1/2/2015,45,25}, {1/1/2015,50,15}, {1/3/2015,40,30}]                             [{1/1/2015, 50, 15}]
        //  [{1/2/2015,45,25}, {1/3/2015,40,30}, {1/1/2015,50,15}]                             [{1/1/2015, 50, 15}]
        //  [{1/1/2015,50,15}, {1/2/2015,45,25}, {1/3/2015,40,20}, {1/4/2015,50,15}]           [{1/1/2015, 50, 15}, {1/4/2015,50,15}]
        ...
        public void TestInit()
        {
            ...
            this.day4 = new DailySummary(new DateTime(2015, 1, 4), 50, 15);
        ...
        public void TestOneDayInData()
        {
            ...
            CollectionAssert.AreEquivalent(this.testList,
                this.weatherData.FindLowestTemperatureDaysOfYear(this.day1.Date.Year));
        }

        [TestMethod]
        public void TestLowestDayIsFirst()
        {
            this.testList.Add(this.day1);
        ...
        [TestMethod]
        public void TestLowestDayIsSecond()
        {
            this.testList.Add(this.day1);
        ...
        [TestMethod]
        public void TestLowestDayIsLast()
        {
            this.testList.Add(this.day1);
        ...
        [TestMethod]
        public void TestMultipleLowestDays()
        {
            this.testList.Add(this.day1);
